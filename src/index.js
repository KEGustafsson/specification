...
function getTv4() {
  ...
  tv4.addSchema('https://signalk.org/specification/1.7.0/schemas/vessel.json', vesselSchema);
  var aircraftSchema = require('../schemas/aircraft.json');
  tv4.addSchema('https://signalk.org/specification/1.7.0/schemas/aircraft.json', aircraftSchema);
  var atonSchema = require('../schemas/aton.json');
  tv4.addSchema('https://signalk.org/specification/1.7.0/schemas/aton.json', atonSchema);
  var sarSchema = require('../schemas/sar.json');
  tv4.addSchema('https://signalk.org/specification/1.7.0/schemas/sar.json', sarSchema);
  var definitions = require('../schemas/definitions.json');
  tv4.addSchema('https://signalk.org/specification/1.7.0/schemas/definitions.json', definitions);

  for (var schema in subSchemas) {
    tv4.addSchema('https://signalk.org/specification/1.7.0/schemas/groups/' + schema + '.json', subSchemas[schema]);
  }
  ...
  tv4.addSchema('https://signalk.org/specification/1.7.0/schemas/external/geojson/geometry.json', externalGeometry);
