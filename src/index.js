...
function getTv4() {
  ...
  tv4.addSchema('https://signalk.org/specification/1.7.1/schemas/vessel.json', vesselSchema);
  var aircraftSchema = require('../schemas/aircraft.json');
  tv4.addSchema('https://signalk.org/specification/1.7.1/schemas/aircraft.json', aircraftSchema);
  var atonSchema = require('../schemas/aton.json');
  tv4.addSchema('https://signalk.org/specification/1.7.1/schemas/aton.json', atonSchema);
  var sarSchema = require('../schemas/sar.json');
  tv4.addSchema('https://signalk.org/specification/1.7.1/schemas/sar.json', sarSchema);
  var definitions = require('../schemas/definitions.json');
  tv4.addSchema('https://signalk.org/specification/1.7.1/schemas/definitions.json', definitions);

  for (var schema in subSchemas) {
    tv4.addSchema('https://signalk.org/specification/1.7.1/schemas/groups/' + schema + '.json', subSchemas[schema]);
  }
  ...
  tv4.addSchema('https://signalk.org/specification/1.7.1/schemas/external/geojson/geometry.json', externalGeometry);
